...
public class Game {
	...
	private static final String PERMISSION_DECK_BONUSES_CSV = "permissionDeckBonuses.csv";
	private static final String PERMISSION_DECK_CITIES_CSV = "permissionDeckCities.csv";
