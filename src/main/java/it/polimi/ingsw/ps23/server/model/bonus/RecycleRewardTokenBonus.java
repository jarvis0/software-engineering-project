...
public class RecycleRewardTokenBonus extends Bonus implements SuperBonus {
	...
	public String checkBonus(Player currentPlayer) {
		if(!currentPlayer.getEmporiumForRecycleRewardToken().getBuiltEmporiumSet().isEmpty()){
			...
			return "Impossible using Recycle Building Permit Bonus because your Built Emporium set is empty, or because all the Reward Tokens of the cities where you have built an emporium gives you Noblity Track Points (0 to skip)";
		}
	}
	@Override
