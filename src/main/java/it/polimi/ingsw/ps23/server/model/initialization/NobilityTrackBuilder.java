...
class NobilityTrackBuilder {
	...
	NobilityTrack makeNobilityTrack(List<String[]> rawNobilityTrackSteps, BonusCache bonusCache) {
		...
		for(String[] rawNobilityTrackStep : rawNobilityTrackSteps) {
			nobilityTrackSteps.add((NobilityTrackStep) new BonusesBuilder(bonusCache).makeBonuses(fields, rawNobilityTrackStep, new NobilityTrackStep()));
		}
